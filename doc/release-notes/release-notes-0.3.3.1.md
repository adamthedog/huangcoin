Huangcoin version 0.3.3.1 is now available from:
...
Added support for Huangcoin URIs in QT wallet.
...
- `722c5dc` Change strings to Huangcoin (uppercase) and other miscellaneous fixes
- `18993f7` Correct translatable string from Bitcoin to Huangcoin
- `a0cb315` Remove duplicate spaces from a string
- `648fc59` Add an option to open the huangcoin.conf in the default editor
- `80dbe2e` Add a notice when selecting edit config in QT
- `02d42ae` Fix Opening on OSX
- `4898c94` Huangcoin-Qt (Windows only): extend Resource File
...
- `0142107` Change Window title to "Huangcoin - Wallet" / misc related renames
...
- `f687b68` Add support for opening huangcoin: URIs directly.
...
- `c5c281a` Rename project to huangcoin-qt
...
- `ca2ae7a` Rename rpcuser from bitcoinrpc --> huangcoinrpc in message dialog
