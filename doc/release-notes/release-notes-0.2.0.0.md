Huangcoin version 0.2.0.0 is now available from:
...
Huangcoin data directory (listed below) and delete everything except the
wallet.dat and huangcoin.conf

Linux : ~/.huangcoin/

Windows : %appdata%\Roaming\Huangcoin
...
- `62a3da1` Update GitHub URLs to point to HuangcoinFoundation/huangcoin
...
- `19ca0ef` Point GitHub URL to HuangcoinFoundation
