Huangcoin version 0.3.1.0 is now available from:
...
- `6a3e798` Huangcoin-Qt (Windows only): enable DEP for huangcoin-qt.exe
...
Miscellaneous:
- `fb66d3f` remove pre-huangcoin protocol versions
