...
* huangcoin.conf: contains configuration settings for huangcoind or huangcoin-qt
* blkindex.dat: block chain index database (BDB)
* blk000?.dat: block data
* database/*: BDB database environment
* db.log: wallet database log file
* debug.log: contains debug information and general logging generated by huangcoind or huangcoin-qt
