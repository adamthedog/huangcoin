#############################################################################
# Makefile for building: huangcoin-qt
# Generated by qmake (2.01a) (Qt 4.8.7) on: Sat Jan 21 13:24:48 2017
# Project:  huangcoin-qt.pro
# Template: app
# Command: /usr/lib/x86_64-linux-gnu/qt4/bin/qmake -o Makefile huangcoin-qt.pro
#############################################################################
...
Makefile: huangcoin-qt.pro  /usr/share/qt4/mkspecs/linux-g++-64/qmake.conf /usr/share/qt4/mkspecs/common/unix.conf \
		/usr/share/qt4/mkspecs/common/linux.conf \
		/usr/share/qt4/mkspecs/common/gcc-base.conf \
		/usr/share/qt4/mkspecs/common/gcc-base-unix.conf \
		/usr/share/qt4/mkspecs/common/g++-base.conf \
	...
	$(QMAKE) -o Makefile huangcoin-qt.pro
...
dist: 
	@$(CHK_DIR_EXISTS) build/huangcoin-qt0.3.3.1 || $(MKDIR) build/huangcoin-qt0.3.3.1 
	$(COPY_FILE) --parents $(SOURCES) $(DIST) build/huangcoin-qt0.3.3.1/ && $(COPY_FILE) --parents src/qt/locale/huangcoin_ar.ts src/qt/locale/huangcoin_ca_ES.ts src/qt/locale/huangcoin_cs.ts src/qt/locale/huangcoin_cs_CZ.ts src/qt/locale/huangcoin_da.ts src/qt/locale/huangcoin_de.ts src/qt/locale/huangcoin_el_GR.ts src/qt/locale/huangcoin_en.ts src/qt/locale/huangcoin_es.ts src/qt/locale/huangcoin_es_CL.ts src/qt/locale/huangcoin_et.ts src/qt/locale/huangcoin_et_EE.ts src/qt/locale/huangcoin_eu_ES.ts src/qt/locale/huangcoin_fa.ts src/qt/locale/huangcoin_fi.ts src/qt/locale/huangcoin_fr.ts src/qt/locale/huangcoin_he.ts src/qt/locale/huangcoin_hi.ts src/qt/locale/huangcoin_hr.ts src/qt/locale/huangcoin_hr_HR.ts src/qt/locale/huangcoin_hu.ts src/qt/locale/huangcoin_id.ts src/qt/locale/huangcoin_it.ts src/qt/locale/huangcoin_lt.ts src/qt/locale/huangcoin_nb.ts src/qt/locale/huangcoin_nl.ts src/qt/locale/huangcoin_pl.ts src/qt/locale/huangcoin_pt_BR.ts src/qt/locale/huangcoin_ro_RO.ts src/qt/locale/huangcoin_ru.ts src/qt/locale/huangcoin_sk.ts src/qt/locale/huangcoin_sk_SK.ts src/qt/locale/huangcoin_sr.ts src/qt/locale/huangcoin_sv.ts src/qt/locale/huangcoin_tr.ts src/qt/locale/huangcoin_tr_TR.ts src/qt/locale/huangcoin_uk.ts src/qt/locale/huangcoin_zh_CN.ts src/qt/locale/huangcoin_zh_TW.ts build/huangcoin-qt0.3.3.1/ && $(COPY_FILE) --parents src/qt/bitcoingui.h src/qt/transactiontablemodel.h src/qt/addresstablemodel.h src/qt/optionsdialog.h src/qt/sendcoinsdialog.h src/qt/coincontroldialog.h src/qt/coincontroltreewidget.h src/qt/addressbookpage.h src/qt/signverifymessagedialog.h src/qt/aboutdialog.h src/qt/editaddressdialog.h src/qt/bitcoinaddressvalidator.h src/addrman.h src/base58.h src/bignum.h src/checkpoints.h src/coincontrol.h src/compat.h src/sync.h src/util.h src/hash.h src/uint256.h src/serialize.h src/strlcpy.h src/main.h src/net.h src/key.h src/db.h src/walletdb.h src/script.h src/init.h src/mruset.h src/scrapesdb.h src/primenodes.h src/json/json_spirit_writer_template.h src/json/json_spirit_writer.h src/json/json_spirit_value.h src/json/json_spirit_utils.h src/json/json_spirit_stream_reader.h src/json/json_spirit_reader_template.h src/json/json_spirit_reader.h src/json/json_spirit_error_position.h src/json/json_spirit.h src/qt/clientmodel.h src/qt/guiutil.h src/qt/transactionrecord.h src/qt/guiconstants.h src/qt/optionsmodel.h src/qt/monitoreddatamapper.h src/qt/transactiondesc.h src/qt/transactiondescdialog.h src/qt/bitcoinamountfield.h src/wallet.h src/keystore.h src/qt/transactionfilterproxy.h src/qt/transactionview.h src/qt/walletmodel.h src/bitcoinrpc.h src/qt/overviewpage.h src/qt/csvmodelwriter.h src/crypter.h src/qt/sendcoinsentry.h src/qt/qvalidatedlineedit.h src/qt/bitcoinunits.h src/qt/qvaluecombobox.h src/qt/askpassphrasedialog.h src/protocol.h src/qt/notificator.h src/qt/qtipcserver.h src/allocators.h src/ui_interface.h src/qt/rpcconsole.h src/version.h src/netbase.h src/kernel.h src/qt/mintingview.h src/qt/mintingtablemodel.h src/qt/mintingfilterproxy.h src/kernelrecord.h src/qt/multisigaddressentry.h src/qt/multisiginputentry.h src/qt/multisigdialog.h src/qt/splashscreen.h build/huangcoin-qt0.3.3.1/ && $(COPY_FILE) --parents src/qt/bitcoin.qrc build/huangcoin-qt0.3.3.1/ && $(COPY_FILE) --parents src/qt/bitcoin.cpp src/qt/bitcoingui.cpp src/qt/transactiontablemodel.cpp src/qt/addresstablemodel.cpp src/qt/optionsdialog.cpp src/qt/sendcoinsdialog.cpp src/qt/coincontroldialog.cpp src/qt/coincontroltreewidget.cpp src/qt/addressbookpage.cpp src/qt/signverifymessagedialog.cpp src/qt/aboutdialog.cpp src/qt/editaddressdialog.cpp src/qt/bitcoinaddressvalidator.cpp src/version.cpp src/sync.cpp src/util.cpp src/netbase.cpp src/key.cpp src/script.cpp src/main.cpp src/init.cpp src/net.cpp src/checkpoints.cpp src/addrman.cpp src/db.cpp src/walletdb.cpp src/scrapesdb.cpp src/primenodes.cpp src/primekeys.cpp src/mpkeys.cpp src/mpkeys_test.cpp src/json/json_spirit_writer.cpp src/json/json_spirit_value.cpp src/json/json_spirit_reader.cpp src/qt/clientmodel.cpp src/qt/guiutil.cpp src/qt/transactionrecord.cpp src/qt/optionsmodel.cpp src/qt/monitoreddatamapper.cpp src/qt/transactiondesc.cpp src/qt/transactiondescdialog.cpp src/qt/bitcoinstrings.cpp src/qt/bitcoinamountfield.cpp src/wallet.cpp src/keystore.cpp src/qt/transactionfilterproxy.cpp src/qt/transactionview.cpp src/qt/walletmodel.cpp src/bitcoinrpc.cpp src/rpcblockchain.cpp src/rpcdump.cpp src/rpcnet.cpp src/rpcwallet.cpp src/rpcrawtransaction.cpp src/qt/overviewpage.cpp src/qt/csvmodelwriter.cpp src/crypter.cpp src/qt/sendcoinsentry.cpp src/qt/qvalidatedlineedit.cpp src/qt/bitcoinunits.cpp src/qt/qvaluecombobox.cpp src/qt/askpassphrasedialog.cpp src/protocol.cpp src/qt/notificator.cpp src/qt/qtipcserver.cpp src/qt/rpcconsole.cpp src/kernel.cpp src/qt/mintingview.cpp src/qt/mintingtablemodel.cpp src/qt/mintingfilterproxy.cpp src/kernelrecord.cpp src/qt/multisigaddressentry.cpp src/qt/multisiginputentry.cpp src/qt/multisigdialog.cpp src/qt/splashscreen.cpp build/huangcoin-qt0.3.3.1/ && $(COPY_FILE) --parents src/qt/forms/sendcoinsdialog.ui src/qt/forms/coincontroldialog.ui src/qt/forms/addressbookpage.ui src/qt/forms/signverifymessagedialog.ui src/qt/forms/aboutdialog.ui src/qt/forms/editaddressdialog.ui src/qt/forms/transactiondescdialog.ui src/qt/forms/overviewpage.ui src/qt/forms/sendcoinsentry.ui src/qt/forms/askpassphrasedialog.ui src/qt/forms/rpcconsole.ui src/qt/forms/multisigaddressentry.ui src/qt/forms/multisiginputentry.ui src/qt/forms/multisigdialog.ui build/huangcoin-qt0.3.3.1/ && $(COPY_FILE) --parents src/qt/locale/huangcoin_ar.ts src/qt/locale/huangcoin_ca_ES.ts src/qt/locale/huangcoin_cs.ts src/qt/locale/huangcoin_cs_CZ.ts src/qt/locale/huangcoin_da.ts src/qt/locale/huangcoin_de.ts src/qt/locale/huangcoin_el_GR.ts src/qt/locale/huangcoin_en.ts src/qt/locale/huangcoin_es.ts src/qt/locale/huangcoin_es_CL.ts src/qt/locale/huangcoin_et.ts src/qt/locale/huangcoin_et_EE.ts src/qt/locale/huangcoin_eu_ES.ts src/qt/locale/huangcoin_fa.ts src/qt/locale/huangcoin_fi.ts src/qt/locale/huangcoin_fr.ts src/qt/locale/huangcoin_he.ts src/qt/locale/huangcoin_hi.ts src/qt/locale/huangcoin_hr.ts src/qt/locale/huangcoin_hr_HR.ts src/qt/locale/huangcoin_hu.ts src/qt/locale/huangcoin_id.ts src/qt/locale/huangcoin_it.ts src/qt/locale/huangcoin_lt.ts src/qt/locale/huangcoin_nb.ts src/qt/locale/huangcoin_nl.ts src/qt/locale/huangcoin_pl.ts src/qt/locale/huangcoin_pt_BR.ts src/qt/locale/huangcoin_ro_RO.ts src/qt/locale/huangcoin_ru.ts src/qt/locale/huangcoin_sk.ts src/qt/locale/huangcoin_sk_SK.ts src/qt/locale/huangcoin_sr.ts src/qt/locale/huangcoin_sv.ts src/qt/locale/huangcoin_tr.ts src/qt/locale/huangcoin_tr_TR.ts src/qt/locale/huangcoin_uk.ts src/qt/locale/huangcoin_zh_CN.ts src/qt/locale/huangcoin_zh_TW.ts build/huangcoin-qt0.3.3.1/ && (cd `dirname build/huangcoin-qt0.3.3.1` && $(TAR) huangcoin-qt0.3.3.1.tar huangcoin-qt0.3.3.1 && $(COMPRESS) huangcoin-qt0.3.3.1.tar) && $(MOVE) `dirname build/huangcoin-qt0.3.3.1`/huangcoin-qt0.3.3.1.tar.gz . && $(DEL_FILE) -r build/huangcoin-qt0.3.3.1
...
genbuildhook: FORCE
	cd /home/adamthedog/Desktop/huangcoin/HNC Source; /bin/sh share/genbuild.sh /home/adamthedog/Desktop/huangcoin/HNC Source/build/build.h
...
compiler_TSQM_make_all: src/qt/locale/huangcoin_ar.qm src/qt/locale/huangcoin_ca_ES.qm src/qt/locale/huangcoin_cs.qm src/qt/locale/huangcoin_cs_CZ.qm src/qt/locale/huangcoin_da.qm src/qt/locale/huangcoin_de.qm src/qt/locale/huangcoin_el_GR.qm src/qt/locale/huangcoin_en.qm src/qt/locale/huangcoin_es.qm src/qt/locale/huangcoin_es_CL.qm src/qt/locale/huangcoin_et.qm src/qt/locale/huangcoin_et_EE.qm src/qt/locale/huangcoin_eu_ES.qm src/qt/locale/huangcoin_fa.qm src/qt/locale/huangcoin_fi.qm src/qt/locale/huangcoin_fr.qm src/qt/locale/huangcoin_he.qm src/qt/locale/huangcoin_hi.qm src/qt/locale/huangcoin_hr.qm src/qt/locale/huangcoin_hr_HR.qm src/qt/locale/huangcoin_hu.qm src/qt/locale/huangcoin_id.qm src/qt/locale/huangcoin_it.qm src/qt/locale/huangcoin_lt.qm src/qt/locale/huangcoin_nb.qm src/qt/locale/huangcoin_nl.qm src/qt/locale/huangcoin_pl.qm src/qt/locale/huangcoin_pt_BR.qm src/qt/locale/huangcoin_ro_RO.qm src/qt/locale/huangcoin_ru.qm src/qt/locale/huangcoin_sk.qm src/qt/locale/huangcoin_sk_SK.qm src/qt/locale/huangcoin_sr.qm src/qt/locale/huangcoin_sv.qm src/qt/locale/huangcoin_tr.qm src/qt/locale/huangcoin_tr_TR.qm src/qt/locale/huangcoin_uk.qm src/qt/locale/huangcoin_zh_CN.qm src/qt/locale/huangcoin_zh_TW.qm
compiler_TSQM_clean:
	-$(DEL_FILE) src/qt/locale/huangcoin_ar.qm src/qt/locale/huangcoin_ca_ES.qm src/qt/locale/huangcoin_cs.qm src/qt/locale/huangcoin_cs_CZ.qm src/qt/locale/huangcoin_da.qm src/qt/locale/huangcoin_de.qm src/qt/locale/huangcoin_el_GR.qm src/qt/locale/huangcoin_en.qm src/qt/locale/huangcoin_es.qm src/qt/locale/huangcoin_es_CL.qm src/qt/locale/huangcoin_et.qm src/qt/locale/huangcoin_et_EE.qm src/qt/locale/huangcoin_eu_ES.qm src/qt/locale/huangcoin_fa.qm src/qt/locale/huangcoin_fi.qm src/qt/locale/huangcoin_fr.qm src/qt/locale/huangcoin_he.qm src/qt/locale/huangcoin_hi.qm src/qt/locale/huangcoin_hr.qm src/qt/locale/huangcoin_hr_HR.qm src/qt/locale/huangcoin_hu.qm src/qt/locale/huangcoin_id.qm src/qt/locale/huangcoin_it.qm src/qt/locale/huangcoin_lt.qm src/qt/locale/huangcoin_nb.qm src/qt/locale/huangcoin_nl.qm src/qt/locale/huangcoin_pl.qm src/qt/locale/huangcoin_pt_BR.qm src/qt/locale/huangcoin_ro_RO.qm src/qt/locale/huangcoin_ru.qm src/qt/locale/huangcoin_sk.qm src/qt/locale/huangcoin_sk_SK.qm src/qt/locale/huangcoin_sr.qm src/qt/locale/huangcoin_sv.qm src/qt/locale/huangcoin_tr.qm src/qt/locale/huangcoin_tr_TR.qm src/qt/locale/huangcoin_uk.qm src/qt/locale/huangcoin_zh_CN.qm src/qt/locale/huangcoin_zh_TW.qm
src/qt/locale/huangcoin_ar.qm: src/qt/locale/huangcoin_ar.ts
	/usr/lib/x86_64-linux-gnu/qt4/bin/lrelease src/qt/locale/huangcoin_ar.ts

src/qt/locale/huangcoin_ca_ES.qm: src/qt/locale/huangcoin_ca_ES.ts
	/usr/lib/x86_64-linux-gnu/qt4/bin/lrelease src/qt/locale/huangcoin_ca_ES.ts

src/qt/locale/huangcoin_cs.qm: src/qt/locale/huangcoin_cs.ts
	/usr/lib/x86_64-linux-gnu/qt4/bin/lrelease src/qt/locale/huangcoin_cs.ts

src/qt/locale/huangcoin_cs_CZ.qm: src/qt/locale/huangcoin_cs_CZ.ts
	/usr/lib/x86_64-linux-gnu/qt4/bin/lrelease src/qt/locale/huangcoin_cs_CZ.ts

src/qt/locale/huangcoin_da.qm: src/qt/locale/huangcoin_da.ts
	/usr/lib/x86_64-linux-gnu/qt4/bin/lrelease src/qt/locale/huangcoin_da.ts

src/qt/locale/huangcoin_de.qm: src/qt/locale/huangcoin_de.ts
	/usr/lib/x86_64-linux-gnu/qt4/bin/lrelease src/qt/locale/huangcoin_de.ts

src/qt/locale/huangcoin_el_GR.qm: src/qt/locale/huangcoin_el_GR.ts
	/usr/lib/x86_64-linux-gnu/qt4/bin/lrelease src/qt/locale/huangcoin_el_GR.ts

src/qt/locale/huangcoin_en.qm: src/qt/locale/huangcoin_en.ts
	/usr/lib/x86_64-linux-gnu/qt4/bin/lrelease src/qt/locale/huangcoin_en.ts

src/qt/locale/huangcoin_es.qm: src/qt/locale/huangcoin_es.ts
	/usr/lib/x86_64-linux-gnu/qt4/bin/lrelease src/qt/locale/huangcoin_es.ts

src/qt/locale/huangcoin_es_CL.qm: src/qt/locale/huangcoin_es_CL.ts
	/usr/lib/x86_64-linux-gnu/qt4/bin/lrelease src/qt/locale/huangcoin_es_CL.ts

src/qt/locale/huangcoin_et.qm: src/qt/locale/huangcoin_et.ts
	/usr/lib/x86_64-linux-gnu/qt4/bin/lrelease src/qt/locale/huangcoin_et.ts

src/qt/locale/huangcoin_et_EE.qm: src/qt/locale/huangcoin_et_EE.ts
	/usr/lib/x86_64-linux-gnu/qt4/bin/lrelease src/qt/locale/huangcoin_et_EE.ts

src/qt/locale/huangcoin_eu_ES.qm: src/qt/locale/huangcoin_eu_ES.ts
	/usr/lib/x86_64-linux-gnu/qt4/bin/lrelease src/qt/locale/huangcoin_eu_ES.ts

src/qt/locale/huangcoin_fa.qm: src/qt/locale/huangcoin_fa.ts
	/usr/lib/x86_64-linux-gnu/qt4/bin/lrelease src/qt/locale/huangcoin_fa.ts

src/qt/locale/huangcoin_fi.qm: src/qt/locale/huangcoin_fi.ts
	/usr/lib/x86_64-linux-gnu/qt4/bin/lrelease src/qt/locale/huangcoin_fi.ts

src/qt/locale/huangcoin_fr.qm: src/qt/locale/huangcoin_fr.ts
	/usr/lib/x86_64-linux-gnu/qt4/bin/lrelease src/qt/locale/huangcoin_fr.ts

src/qt/locale/huangcoin_he.qm: src/qt/locale/huangcoin_he.ts
	/usr/lib/x86_64-linux-gnu/qt4/bin/lrelease src/qt/locale/huangcoin_he.ts

src/qt/locale/huangcoin_hi.qm: src/qt/locale/huangcoin_hi.ts
	/usr/lib/x86_64-linux-gnu/qt4/bin/lrelease src/qt/locale/huangcoin_hi.ts

src/qt/locale/huangcoin_hr.qm: src/qt/locale/huangcoin_hr.ts
	/usr/lib/x86_64-linux-gnu/qt4/bin/lrelease src/qt/locale/huangcoin_hr.ts

src/qt/locale/huangcoin_hr_HR.qm: src/qt/locale/huangcoin_hr_HR.ts
	/usr/lib/x86_64-linux-gnu/qt4/bin/lrelease src/qt/locale/huangcoin_hr_HR.ts

src/qt/locale/huangcoin_hu.qm: src/qt/locale/huangcoin_hu.ts
	/usr/lib/x86_64-linux-gnu/qt4/bin/lrelease src/qt/locale/huangcoin_hu.ts

src/qt/locale/huangcoin_id.qm: src/qt/locale/huangcoin_id.ts
	/usr/lib/x86_64-linux-gnu/qt4/bin/lrelease src/qt/locale/huangcoin_id.ts

src/qt/locale/huangcoin_it.qm: src/qt/locale/huangcoin_it.ts
	/usr/lib/x86_64-linux-gnu/qt4/bin/lrelease src/qt/locale/huangcoin_it.ts

src/qt/locale/huangcoin_lt.qm: src/qt/locale/huangcoin_lt.ts
	/usr/lib/x86_64-linux-gnu/qt4/bin/lrelease src/qt/locale/huangcoin_lt.ts

src/qt/locale/huangcoin_nb.qm: src/qt/locale/huangcoin_nb.ts
	/usr/lib/x86_64-linux-gnu/qt4/bin/lrelease src/qt/locale/huangcoin_nb.ts

src/qt/locale/huangcoin_nl.qm: src/qt/locale/huangcoin_nl.ts
	/usr/lib/x86_64-linux-gnu/qt4/bin/lrelease src/qt/locale/huangcoin_nl.ts

src/qt/locale/huangcoin_pl.qm: src/qt/locale/huangcoin_pl.ts
	/usr/lib/x86_64-linux-gnu/qt4/bin/lrelease src/qt/locale/huangcoin_pl.ts

src/qt/locale/huangcoin_pt_BR.qm: src/qt/locale/huangcoin_pt_BR.ts
	/usr/lib/x86_64-linux-gnu/qt4/bin/lrelease src/qt/locale/huangcoin_pt_BR.ts

src/qt/locale/huangcoin_ro_RO.qm: src/qt/locale/huangcoin_ro_RO.ts
	/usr/lib/x86_64-linux-gnu/qt4/bin/lrelease src/qt/locale/huangcoin_ro_RO.ts

src/qt/locale/huangcoin_ru.qm: src/qt/locale/huangcoin_ru.ts
	/usr/lib/x86_64-linux-gnu/qt4/bin/lrelease src/qt/locale/huangcoin_ru.ts

src/qt/locale/huangcoin_sk.qm: src/qt/locale/huangcoin_sk.ts
	/usr/lib/x86_64-linux-gnu/qt4/bin/lrelease src/qt/locale/huangcoin_sk.ts

src/qt/locale/huangcoin_sk_SK.qm: src/qt/locale/huangcoin_sk_SK.ts
	/usr/lib/x86_64-linux-gnu/qt4/bin/lrelease src/qt/locale/huangcoin_sk_SK.ts

src/qt/locale/huangcoin_sr.qm: src/qt/locale/huangcoin_sr.ts
	/usr/lib/x86_64-linux-gnu/qt4/bin/lrelease src/qt/locale/huangcoin_sr.ts

src/qt/locale/huangcoin_sv.qm: src/qt/locale/huangcoin_sv.ts
	/usr/lib/x86_64-linux-gnu/qt4/bin/lrelease src/qt/locale/huangcoin_sv.ts

src/qt/locale/huangcoin_tr.qm: src/qt/locale/huangcoin_tr.ts
	/usr/lib/x86_64-linux-gnu/qt4/bin/lrelease src/qt/locale/huangcoin_tr.ts

src/qt/locale/huangcoin_tr_TR.qm: src/qt/locale/huangcoin_tr_TR.ts
	/usr/lib/x86_64-linux-gnu/qt4/bin/lrelease src/qt/locale/huangcoin_tr_TR.ts

src/qt/locale/huangcoin_uk.qm: src/qt/locale/huangcoin_uk.ts
	/usr/lib/x86_64-linux-gnu/qt4/bin/lrelease src/qt/locale/huangcoin_uk.ts

src/qt/locale/huangcoin_zh_CN.qm: src/qt/locale/huangcoin_zh_CN.ts
	/usr/lib/x86_64-linux-gnu/qt4/bin/lrelease src/qt/locale/huangcoin_zh_CN.ts

src/qt/locale/huangcoin_zh_TW.qm: src/qt/locale/huangcoin_zh_TW.ts
	/usr/lib/x86_64-linux-gnu/qt4/bin/lrelease src/qt/locale/huangcoin_zh_TW.ts

compiler_moc_header_make_all: build/moc_bitcoingui.cpp build/moc_transactiontablemodel.cpp build/moc_addresstablemodel.cpp build/moc_optionsdialog.cpp build/moc_sendcoinsdialog.cpp build/moc_coincontroldialog.cpp build/moc_coincontroltreewidget.cpp build/moc_addressbookpage.cpp build/moc_signverifymessagedialog.cpp build/moc_aboutdialog.cpp build/moc_editaddressdialog.cpp build/moc_bitcoinaddressvalidator.cpp build/moc_clientmodel.cpp build/moc_guiutil.cpp build/moc_optionsmodel.cpp build/moc_monitoreddatamapper.cpp build/moc_transactiondesc.cpp build/moc_transactiondescdialog.cpp build/moc_bitcoinamountfield.cpp build/moc_transactionfilterproxy.cpp build/moc_transactionview.cpp build/moc_walletmodel.cpp build/moc_overviewpage.cpp build/moc_csvmodelwriter.cpp build/moc_sendcoinsentry.cpp build/moc_qvalidatedlineedit.cpp build/moc_qvaluecombobox.cpp build/moc_askpassphrasedialog.cpp build/moc_notificator.cpp build/moc_rpcconsole.cpp build/moc_mintingview.cpp build/moc_mintingtablemodel.cpp build/moc_mintingfilterproxy.cpp build/moc_multisigaddressentry.cpp build/moc_multisiginputentry.cpp build/moc_multisigdialog.cpp build/moc_splashscreen.cpp
...
qrc_bitcoin.cpp: src/qt/bitcoin.qrc \
		...
		src/qt/res/icons/huangcoin.png \
		...
		src/qt/res/icons/huangcoin_testnet.png \
		src/qt/res/icons/huangcoin.ico
...
build/scrapesdb.o: src/scrapesdb.cpp src/init.h \
		src/wallet.h \
		src/main.h \
		src/bignum.h \
		src/util.h \
		...
		src/json/json_spirit_utils.h \
		src/scrapesdb.h
	$(CXX) -c $(CXXFLAGS) $(INCPATH) -o build/scrapesdb.o src/scrapesdb.cpp

build/primenodes.o: src/primenodes.cpp src/base58.h \
		src/bignum.h \
		src/util.h \
		src/uint256.h \
		src/netbase.h \
		...
		src/addrman.h \
		src/primenodes.h
	$(CXX) -c $(CXXFLAGS) $(INCPATH) -o build/primenodes.o src/primenodes.cpp

build/primekeys.o: src/primekeys.cpp src/primenodes.h \
		src/db.h \
		src/main.h \
		src/bignum.h \
		src/util.h \
		...
		src/crypter.h \
		src/key.h
	$(CXX) -c $(CXXFLAGS) $(INCPATH) -o build/primekeys.o src/primekeys.cpp

build/mpkeys.o: src/mpkeys.cpp src/primenodes.h \
		src/db.h \
		src/main.h \
		src/bignum.h \
		src/util.h \
		...
		src/crypter.h \
		src/key.h
	$(CXX) -c $(CXXFLAGS) $(INCPATH) -o build/mpkeys.o src/mpkeys.cpp

build/mpkeys_test.o: src/mpkeys_test.cpp src/primenodes.h \
		src/db.h \
		src/main.h \
		src/bignum.h \
		src/util.h \
		...
		src/crypter.h \
		src/key.h
	$(CXX) -c $(CXXFLAGS) $(INCPATH) -o build/mpkeys_test.o src/mpkeys_test.cpp
...
build/rpcwallet.o: src/rpcwallet.cpp src/init.h \
		src/wallet.h \
		src/main.h \
		src/bignum.h \
		src/util.h \
