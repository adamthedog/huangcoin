...
static const int STAKE_TARGET_SPACING = 1 * 100; // 100-second block
...
static const int MAX_TIME_SINCE_BEST_BLOCK = 14; // how many seconds to wait before sending next PushGetBlocks()
...
public:
    ...
    */
    ...
    bool GetCoinAge(CTxDB& txdb, uint64& nCoinAge) const;  // huangcoin: get transaction coin age
...
public:
    ...
    // huangcoin: block signature - signed by coin base txout[0]'s owner
    ...
    // huangcoin: two types of block: proof-of-work or proof-of-stake
    ...
    // huangcoin: get max transaction timestamp
    ...
    bool AcceptBlock();
    bool GetCoinAge(uint64& nCoinAge) const; // huangcoin: calculate total coin age spent in block
    bool SignBlock(const CKeyStore& keystore);
    bool CheckBlockSignature() const;
    unsigned int GetStakeEntropyBit() const; // huangcoin: entropy bit for stake modifier if chosen by modifier
...
public:
    ...
    unsigned int nFile;
    unsigned int nBlockPos;
    CBigNum bnChainTrust; // huangcoin: trust score of block chain
    int nHeight;
    int64 nMint;
    int64 nMoneySupply;

    unsigned int nFlags;  // huangcoin: block index flags
    enum
    {
