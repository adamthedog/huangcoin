...
// for both huangcoind and huangcoin(-qt), to make it harder for attackers to
// target servers or GUI users specifically.

// For the current run of Huangcoin releases, the client name should be selected from
