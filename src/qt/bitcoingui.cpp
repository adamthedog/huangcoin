 ...
 * The Huangcoin Developers 2011-2013
 */
...
{
    resize(850, 550);
    setWindowTitle(tr("Huangcoin") + " - " + tr("Wallet"));
#ifndef Q_OS_MAC
    setWindowIcon(QIcon(":icons/huangcoin"));
#else
...
void BitcoinGUI::createActions()
{
    ...
    sendCoinsAction->setToolTip(tr("Send coins to a Huangcoin address"));
    ...
    aboutAction = new QAction(QIcon(":/icons/huangcoin"), tr("&About Huangcoin"), this);
    aboutAction->setToolTip(tr("Show information about Huangcoin"));
    aboutAction->setMenuRole(QAction::AboutRole);
    aboutQtAction = new QAction(QIcon(":/trolltech/qmessagebox/images/qtlogo-64.png"), tr("About &Qt"), this);
    aboutQtAction->setToolTip(tr("Show information about Qt"));
    aboutQtAction->setMenuRole(QAction::AboutQtRole);
    optionsAction = new QAction(QIcon(":/icons/options"), tr("&Options..."), this);
    optionsAction->setToolTip(tr("Modify configuration options for Huangcoin"));
    optionsAction->setMenuRole(QAction::PreferencesRole);
    toggleHideAction = new QAction(QIcon(":/icons/huangcoin"), tr("Show/Hide &Huangcoin"), this);
    toggleHideAction->setToolTip(tr("Show or hide the Huangcoin window"));
    ...
    editConfigAction->setToolTip(tr("Edit the huangcoin.conf file in the default text editor"));
...
#ifndef Q_OS_MAC
            setWindowIcon(QIcon(":icons/huangcoin_testnet"));
#else
            MacDockIconHandler::instance()->setIcon(QIcon(":icons/huangcoin_testnet"));
#endif
            if(trayIcon)
            {
...
void BitcoinGUI::createTrayIcon()
{
    ...
    trayIcon->setToolTip(tr("Huangcoin client"));
...
void BitcoinGUI::trayIconActivated(QSystemTrayIcon::ActivationReason reason)
{
    ...
    {
        // Click on system tray icon triggers "show/hide Huangcoin"
...
void BitcoinGUI::setNumConnections(int count)
{
    ...
    labelConnectionsIcon->setToolTip(tr("%n active connection(s) to Huangcoin network", "", count));
}
