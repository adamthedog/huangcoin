       ...
       OptionsPage(parent)
{
    ...
    bitcoin_at_startup = new QCheckBox(tr("&Start Huangcoin on system login"));
    bitcoin_at_startup->setToolTip(tr("Automatically start Huangcoin after logging in to the system"));
    ...
    OptionsPage(parent), restart_warning_displayed(false)
{
    ...
    lang->setToolTip(tr("The user interface language can be set here. This setting will only take effect after restarting Huangcoin."));
    ...
    display_addresses->setToolTip(tr("Whether to show Huangcoin addresses in the transaction list"));
...
void DisplayOptionsPage::showRestartWarning()
{
    ...
    {
        QMessageBox::warning(this, tr("Warning"), tr("This setting will take effect after restarting Huangcoin."), QMessageBox::Ok);
       ...
       OptionsPage(parent)
{
    ...
    map_port_upnp->setToolTip(tr("Automatically open the Huangcoin client port on the router. This only works when your router supports UPnP and it is enabled."));
    layout->addWidget(map_port_upnp);

    connect_socks4 = new QCheckBox(tr("&Connect through SOCKS4 proxy:"));
    connect_socks4->setToolTip(tr("Connect to the Huangcoin network through a SOCKS4 proxy (e.g. when connecting through Tor)"));
